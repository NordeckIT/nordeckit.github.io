    ...
    return function e(t, r, n) {
        ...
        1: [function(e, t, r) {
            ...
            function n(e, t, r, n, i) {
                ...
                if (a += d.writeIceParameters(e.iceGatherer.getLocalParameters()), a += d.writeDtlsParameters(e.dtlsTransport.getLocalParameters(), "offer" === r ? "actpass" : i || "active"), a += "a=mid:" + e.mid + "\r\n", e.rtpSender && e.rtpReceiver ? a += "a=sendrecv\r\n" : e.rtpSender ? a += "a=sendonly\r\n" : e.rtpReceiver ? a += "a=recvonly\r\n" : a += "a=inactive\r\n", e.rtpSender) {
            ...
            t.exports = function(e, t) {
                ...
                var f = function(r) {
                    ...
                    if (r.iceServers = i(r.iceServers || [], t), this._iceGatherers = [], r.iceCandidatePoolSize)
                    ...
                    this._config = r, this.transceivers = [], this._sdpSessionId = d.generateSessionId(), this._sdpSessionVersion = 0, this._dtlsRole = void 0, this._isClosed = !1
                };
                f.prototype.onicecandidate = null, f.prototype.onaddstream = null, f.prototype.ontrack = null, f.prototype.onremovestream = null, f.prototype.onsignalingstatechange = null, f.prototype.oniceconnectionstatechange = null, f.prototype.onconnectionstatechange = null, f.prototype.onicegatheringstatechange = null, f.prototype.onnegotiationneeded = null, f.prototype.ondatachannel = null, f.prototype._dispatchEvent = function(e, t) {
                    ...
                    if (!i.onlocalcandidate) {
                        ...
                        this.transceivers[r].bufferedCandidateEvents = null, i.removeEventListener("localcandidate", this.transceivers[r].bufferCandidates), i.onlocalcandidate = function(e) {
                            if (!(n.usingBundle && r > 0)) {
                                ...
                                var p = d.getMediaSections(n.localDescription.sdp);
                                p[a.candidate.sdpMLineIndex] += s ? "a=end-of-candidates\r\n" : "a=" + a.candidate.candidate + "\r\n", n.localDescription.sdp = d.getDescription(n.localDescription.sdp) + p.join("");
                                var u = n.transceivers.every(function(e) {
                                    return e.iceGatherer && "completed" === e.iceGatherer.state
                                });
                                "gathering" !== n.iceGatheringState && (n.iceGatheringState = "gathering", n._emitGatheringStateChange()), s || n._dispatchEvent("icecandidate", a), u && (n._dispatchEvent("icecandidate", new Event("icecandidate")), n.iceGatheringState = "complete", n._emitGatheringStateChange())
                            }
                    ...
                    if (!o("setLocalDescription", e.type, t.signalingState) || t._isClosed) return Promise.reject(c("InvalidStateError", "Can not set local " + e.type + " in state " + t.signalingState));
                    var r, n;
                    if ("offer" === e.type) r = d.splitSections(e.sdp), n = r.shift(), r.forEach(function(e, r) {
                        var n = d.parseRtpParameters(e);
                        t.transceivers[r].localCapabilities = n
                    }), t.transceivers.forEach(function(e, r) {
                        t._gather(e.mid, r)
                    });
                    else if ("answer" === e.type) {
                        r = d.splitSections(t.remoteDescription.sdp), n = r.shift();
                        var i = d.matchPrefix(n, "a=ice-lite").length > 0;
                        r.forEach(function(e, r) {
                            ...
                            if (!(d.isRejected(e) && 0 === d.matchPrefix(e, "a=bundle-only").length || o.rejected)) {
                                var l = d.getIceParameters(e, n),
                                    m = d.getDtlsParameters(e, n);
                                i && (m.role = "server"), t.usingBundle && 0 !== r || (t._gather(o.mid, r), "new" === c.state && c.start(s, l, i ? "controlling" : "controlled"), "new" === p.state && p.start(m));
                                var v = a(u, f);
                    ...
                    if (!o("setRemoteDescription", n.type, i.signalingState) || i._isClosed) return Promise.reject(c("InvalidStateError", "Can not set remote " + n.type + " in state " + i.signalingState));
                    var a = {};
                    i.remoteStreams.forEach(function(e) {
                        a[e.id] = e
                    });
                    var f = [],
                        l = d.splitSections(n.sdp),
                        m = l.shift(),
                        v = d.matchPrefix(m, "a=ice-lite").length > 0,
                        h = d.matchPrefix(m, "a=group:BUNDLE ").length > 0;
                    i.usingBundle = h;
                    var g = d.matchPrefix(m, "a=ice-options:")[0];
                    return i.canTrickleIceCandidates = !!g && g.substr(14).split(" ").indexOf("trickle") >= 0, l.forEach(function(o, c) {
                        var u = d.splitLines(o),
                            l = d.getKind(o),
                            g = d.isRejected(o) && 0 === d.matchPrefix(o, "a=bundle-only").length,
                            y = u[0].substr(2).split(" ")[2],
                            C = d.getDirection(o, m),
                            T = d.parseMsid(o),
                            S = d.getMid(o) || d.generateIdentifier();
                        if ("application" === l && "DTLS/SCTP" === y || g) return void(i.transceivers[c] = {
                            mid: S,
                            kind: l,
                            rejected: !0
                        });
                        !g && i.transceivers[c] && i.transceivers[c].rejected && (i.transceivers[c] = i._createTransceiver(l, !0));
                        var R, P, b, E, k, w, _, x, O, M = d.parseRtpParameters(o),
                            D, L;
                        g || (D = d.getIceParameters(o, m), L = d.getDtlsParameters(o, m), L.role = "client"), _ = d.parseRtpEncodingParameters(o);
                        var I = d.parseRtcpParameters(o),
                            j = d.matchPrefix(o, "a=end-of-candidates", m).length > 0,
                            N = d.matchPrefix(o, "a=candidate:").map(function(e) {
                                return d.parseCandidate(e)
                            }).filter(function(e) {
                                return 1 === e.component
                            });
                        if (("offer" === n.type || "answer" === n.type) && !g && h && c > 0 && i.transceivers[c] && (i._disposeIceAndDtlsTransports(c), i.transceivers[c].iceGatherer = i.transceivers[0].iceGatherer, i.transceivers[c].iceTransport = i.transceivers[0].iceTransport, i.transceivers[c].dtlsTransport = i.transceivers[0].dtlsTransport, i.transceivers[c].rtpSender && i.transceivers[c].rtpSender.setTransport(i.transceivers[0].dtlsTransport), i.transceivers[c].rtpReceiver && i.transceivers[c].rtpReceiver.setTransport(i.transceivers[0].dtlsTransport)), "offer" !== n.type || g) "answer" !== n.type || g || (R = i.transceivers[c], P = R.iceGatherer, b = R.iceTransport, E = R.dtlsTransport, k = R.rtpReceiver, w = R.sendEncodingParameters, x = R.localCapabilities, i.transceivers[c].recvEncodingParameters = _, i.transceivers[c].remoteCapabilities = M, i.transceivers[c].rtcpParameters = I, N.length && "new" === b.state && (!v && !j || h && 0 !== c ? N.forEach(function(e) {
                            s(R.iceTransport, e)
                        }) : b.setRemoteCandidates(N)), h && 0 !== c || ("new" === b.state && b.start(P, D, "controlling"), "new" === E.state && E.start(L)), i._transceive(R, "sendrecv" === C || "recvonly" === C, "sendrecv" === C || "sendonly" === C), !k || "sendrecv" !== C && "sendonly" !== C ? delete R.rtpReceiver : (O = k.track, T ? (a[T.stream] || (a[T.stream] = new e.MediaStream), r(O, a[T.stream]), f.push([O, k, a[T.stream]])) : (a.default || (a.default = new e.MediaStream), r(O, a.default), f.push([O, k, a.default]))));
                        else {
                            R = i.transceivers[c] || i._createTransceiver(l), R.mid = S, R.iceGatherer || (R.iceGatherer = i._createIceGatherer(c, h)), N.length && "new" === R.iceTransport.state && (!j || h && 0 !== c ? N.forEach(function(e) {
                                s(R.iceTransport, e)
                            }) : R.iceTransport.setRemoteCandidates(N)), x = e.RTCRtpReceiver.getCapabilities(l), t < 15019 && (x.codecs = x.codecs.filter(function(e) {
                                return "rtx" !== e.name
                            })), w = R.sendEncodingParameters || [{
                                ssrc: 1001 * (2 * c + 2)
                            }];
                            var A = !1;
                            if ("sendrecv" === C || "sendonly" === C) {
                                if (A = !R.rtpReceiver, k = R.rtpReceiver || new e.RTCRtpReceiver(R.dtlsTransport, l), A) {
                                    var U;
                                    O = k.track, T && "-" === T.stream || (T ? (a[T.stream] || (a[T.stream] = new e.MediaStream, Object.defineProperty(a[T.stream], "id", {
                                        get: function() {
                                            return T.stream
                                        }
                                    ...
                                    }), U = a[T.stream]) : (a.default || (a.default = new e.MediaStream), U = a.default)), U && (r(O, U), R.associatedRemoteMediaStreams.push(U)), f.push([O, k, U])
                                }
                            ...
                            R.localCapabilities = x, R.remoteCapabilities = M, R.rtpReceiver = k, R.rtcpParameters = I, R.sendEncodingParameters = w, R.recvEncodingParameters = _, i._transceive(i.transceivers[c], !1, A)
                        }
                    }), void 0 === i._dtlsRole && (i._dtlsRole = "offer" === n.type ? "active" : "passive"), i.remoteDescription = {
                        type: n.type,
                        sdp: n.sdp
                    }, "offer" === n.type ? i._updateSignalingState("have-remote-offer") : i._updateSignalingState("stable"), Object.keys(a).forEach(function(t) {
                        var r = a[t];
                    ...
                    if (o) {
                        ...
                        void 0 !== o.offerToReceiveAudio && (i = !0 === o.offerToReceiveAudio ? 1 : !1 === o.offerToReceiveAudio ? 0 : o.offerToReceiveAudio), void 0 !== o.offerToReceiveVideo && (a = !0 === o.offerToReceiveVideo ? 1 : !1 === o.offerToReceiveVideo ? 0 : o.offerToReceiveVideo)
                    }
                    for (r.transceivers.forEach(function(e) {
                        "audio" === e.kind ? --i < 0 && (e.wantReceive = !1) : "video" === e.kind && --a < 0 && (e.wantReceive = !1)
                    }); i > 0 || a > 0;) i > 0 && (r._createTransceiver("audio"), i--), a > 0 && (r._createTransceiver("video"), a--);
                    var s = d.writeSessionBoilerplate(r._sdpSessionId, r._sdpSessionVersion++);
                    r.transceivers.forEach(function(n, i) {
                        var a = n.track,
                            o = n.kind,
                            s = n.mid || d.generateIdentifier();
                        ...
                        a && t >= 15019 && "video" === o && !p[0].rtx && (p[0].rtx = {
                            ssrc: p[0].ssrc + 1
                        }), n.wantReceive && (n.rtpReceiver = new e.RTCRtpReceiver(n.dtlsTransport, o)), n.localCapabilities = c, n.sendEncodingParameters = p
                    ...
                    var i = d.writeSessionBoilerplate(r._sdpSessionId, r._sdpSessionVersion++);
                    ...
                    r.transceivers.forEach(function(e, s) {
                        if (!(s + 1 > o)) {
                            if (e.rejected) return "application" === e.kind ? i += "m=application 0 DTLS/SCTP 5000\r\n" : "audio" === e.kind ? i += "m=audio 0 UDP/TLS/RTP/SAVPF 0\r\na=rtpmap:0 PCMU/8000\r\n" : "video" === e.kind && (i += "m=video 0 UDP/TLS/RTP/SAVPF 120\r\na=rtpmap:120 VP8/90000\r\n"), void(i += "c=IN IP4 0.0.0.0\r\na=inactive\r\na=mid:" + e.mid + "\r\n");
                            if (e.stream) {
                                var c;
                            ...
                            }).length && e.sendEncodingParameters[0].rtx && delete e.sendEncodingParameters[0].rtx, i += n(e, d, "answer", e.stream, r._dtlsRole), e.rtcpParameters && e.rtcpParameters.reducedSize && (i += "a=rtcp-rsize\r\n")
                        }
                    });
                    ...
                    return e && void 0 === e.sdpMLineIndex && !e.sdpMid ? Promise.reject(new TypeError("sdpMLineIndex or sdpMid required")) : new Promise(function(n, i) {
                        if (!t.remoteDescription) return i(c("InvalidStateError", "Can not add ICE candidate without a remote description"));
                        if (e && "" !== e.candidate) {
                            var a = e.sdpMLineIndex;
                            if (e.sdpMid)
                                for (var o = 0; o < t.transceivers.length; o++)
                                    if (t.transceivers[o].mid === e.sdpMid) {
                                        a = o;
                                        break
                                    }
                            var p = t.transceivers[a];
                            if (!p) return i(c("OperationError", "Can not add ICE candidate"));
                            if (p.rejected) return n();
                            var u = Object.keys(e.candidate).length > 0 ? d.parseCandidate(e.candidate) : {};
                            if ("tcp" === u.protocol && (0 === u.port || 9 === u.port)) return n();
                            if (u.component && 1 !== u.component) return n();
                            if ((0 === a || a > 0 && p.iceTransport !== t.transceivers[0].iceTransport) && !s(p.iceTransport, u)) return i(c("OperationError", "Can not add ICE candidate"));
                            var f = e.candidate.trim();
                            0 === f.indexOf("a=") && (f = f.substr(2)), r = d.getMediaSections(t.remoteDescription.sdp), r[a] += "a=" + (u.type ? f : "end-of-candidates") + "\r\n", t.remoteDescription.sdp = d.getDescription(t.remoteDescription.sdp) + r.join("")
                        } else
                            for (var l = 0; l < t.transceivers.length && (t.transceivers[l].rejected || (t.transceivers[l].iceTransport.addRemoteCandidate({}), r = d.getMediaSections(t.remoteDescription.sdp), r[l] += "a=end-of-candidates\r\n", t.remoteDescription.sdp = d.getDescription(t.remoteDescription.sdp) + r.join(""), !t.usingBundle)); l++);
                        n()
                    })
                ...
                }), l = ["setLocalDescription", "setRemoteDescription", "addIceCandidate"], l.forEach(function(e) {
                    var t = f.prototype[e];
                    f.prototype[e] = function() {
                        var e = arguments;
        ...
        2: [function(e, t, r) {
            ...
            n.generateIdentifier = function() {
                ...
                for (var t = {}, r, n = e.substr(e.indexOf(" ") + 1).split(";"), i = 0; i < n.length; i++) r = n[i].trim().split("="), t[r[0].trim()] = r[1];
                return t
                ...
                var t = [],
                    ...
                    o = n.matchPrefix(e, "a=ssrc:").map(function(e) {
                        return n.parseSsrcMedia(e)
                    }).filter(function(e) {
                        return "cname" === e.attribute
                    }),
                    s = o.length > 0 && o[0].ssrc,
                    c, d = n.matchPrefix(e, "a=ssrc-group:FID").map(function(e) {
                        var t = e.split(" ");
                        return t.shift(), t.map(function(e) {
                            return parseInt(e, 10)
                        })
                    });
                d.length > 0 && d[0].length > 1 && d[0][0] === s && (c = d[0][1]), r.codecs.forEach(function(e) {
                    if ("RTX" === e.name.toUpperCase() && e.parameters.apt) {
                        ...
                        t.push(r), i && (r = JSON.parse(JSON.stringify(r)), r.fec = {
                            ssrc: c,
                ...
                return p.length && (p = 0 === p[0].indexOf("b=TIAS:") ? parseInt(p[0].substr(7), 10) : 0 === p[0].indexOf("b=AS:") ? 1e3 * parseInt(p[0].substr(5), 10) * .95 - 16e3 : void 0, t.forEach(function(e) {
                    e.maxBitrate = p
                })), t
            }, n.parseRtcpParameters = function(e) {
                var t = {},
                    r, i = n.matchPrefix(e, "a=ssrc:").map(function(e) {
                        return n.parseSsrcMedia(e)
                    }).filter(function(e) {
                        return "cname" === e.attribute
                    })[0];
                i && (t.cname = i.value, t.ssrc = i.ssrc);
                var a = n.matchPrefix(e, "a=rtcp-rsize");
        ...
        5: [function(e, t, r) {
            ...
            t.exports = {
                ...
                shimAddTrackRemoveTrack: function(e) {
                    ...
                    if (e.RTCPeerConnection.prototype.addTrack && i.version >= 65) return this.shimAddTrackRemoveTrackWithNative(e);
                        ...
                        e.RTCPeerConnection = function(e, t) {
                            if (e && e.iceServers) {
                                for (var i = [], a = 0; a < e.iceServers.length; a++) {
                                    ...
                                    !o.hasOwnProperty("urls") && o.hasOwnProperty("url") ? (n.deprecated("RTCIceServer.url", "RTCIceServer.urls"), o = JSON.parse(JSON.stringify(o)), o.urls = o.url, i.push(o)) : i.push(e.iceServers[a])
                                }
                                e.iceServers = i
                            }
                            return new r(e, t)
                ...
                shimMaxMessageSize: function(e) {
                    if (!e.RTCSctpTransport && e.RTCPeerConnection) {
                        ...
                        var r = function(e) {
                            ...
                            o = function(e) {
                                var r = 65536;
                                return "firefox" === t.browser && (r = t.version < 57 ? -1 === e ? 16384 : 2147483637 : 57 === t.version ? 65535 : 65536), r
                            },
                            s = function(e, r) {
                                var i = 65536;
                        ...
                        e.RTCPeerConnection.prototype.setRemoteDescription = function() {
                            ...
                            if (e._sctp = null, r(arguments[0])) {
                                var t = a(arguments[0]),
                                    ...
                                    i = s(arguments[0], t),
                                    d;
                                d = 0 === n && 0 === i ? Number.POSITIVE_INFINITY : 0 === n || 0 === i ? Math.max(n, i) : Math.min(n, i);
                                var p = {};
                    ...
                    if (e.RTCPeerConnection && "createDataChannel" in e.RTCPeerConnection.prototype) {
                        ...
                        e.RTCPeerConnection.prototype.createDataChannel = function() {
                            ...
                            return r.send = function() {
                                var t = this,
                                    r = arguments[0];
                                if ((r.length || r.size || r.byteLength) > e.sctp.maxMessageSize) throw new DOMException("Message too large (can send a maximum of " + e.sctp.maxMessageSize + " bytes)", "TypeError");
            ...
            t.exports = function(e) {
                ...
                if (!(t.version > 55 && "autoGainControl" in r.mediaDevices.getSupportedConstraints())) {
                    ...
                    if (r.mediaDevices.getUserMedia = function(e) {
                        return "object" == typeof e && "object" == typeof e.audio && (e = JSON.parse(JSON.stringify(e)), u(e.audio, "autoGainControl", "mozAutoGainControl"), u(e.audio, "noiseSuppression", "mozNoiseSuppression")), f(e)
                    ...
                    if (a && a.prototype.applyConstraints) {
                        ...
                        a.prototype.applyConstraints = function(e) {
                            return "audio" === this.kind && "object" == typeof e && (e = JSON.parse(JSON.stringify(e)), u(e, "autoGainControl", "mozAutoGainControl"), u(e, "noiseSuppression", "mozNoiseSuppression")), m.apply(this, [e])
                        }
                    }
                }
                ...
                shimRTCIceServerUrls: function(e) {
                    ...
                    e.RTCPeerConnection = function(e, r) {
                        if (e && e.iceServers) {
                            for (var i = [], a = 0; a < e.iceServers.length; a++) {
                                var o = e.iceServers[a];
                                !o.hasOwnProperty("urls") && o.hasOwnProperty("url") ? (n.deprecated("RTCIceServer.url", "RTCIceServer.urls"), o = JSON.parse(JSON.stringify(o)), o.urls = o.url, delete o.url, i.push(o)) : i.push(e.iceServers[a])
                            }
                            e.iceServers = i
                        }
                        return new t(e, r)
